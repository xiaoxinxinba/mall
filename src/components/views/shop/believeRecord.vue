        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div>{{scope.row.crMark}} {{scope.row.crScore}}</div>
            </template>
          </el-table-column>
          <el-table-column
            prop="operation"
...
<script>
  ...
  import GetBusinessCreditRecord from '../../../api/ShopInfo/GetBusinessCreditRecord'
  ...
  export default {
    ...
    methods: {
      ...
      ,
      getBusinessCreditRecord(){
        this.currentTime = new Date().toLocaleString();
        let crMark = ''
          crMark = encodeURIComponent(this.crMark)

        GetBusinessCreditRecord.call(this,`?input.crMark=${crMark}&input.startTime=${this.startTime}&input.endTime=${this.endTime}&input.pageSize=${this.pageSize}&input.pageIndex=${this.pageIndex}&input.clientTimespan=${this.currentTime}`).then(res=>{
           if(res.data.code === 1){
